...
bool Terrain::InitializeBuffers(ID3D11Device* device)
{
	...
	{
		m_vertices[i].position = D3DXVECTOR3(m_terrainModel[i].x, m_terrainModel[i].y, m_terrainModel[i].z);
		m_vertices[i].texture = D3DXVECTOR2(m_terrainModel[i].tu, m_terrainModel[i].tv);
		m_vertices[i].normal = D3DXVECTOR3(m_terrainModel[i].nx, m_terrainModel[i].ny, m_terrainModel[i].nz);
		m_vertices[i].tangent = D3DXVECTOR3(m_terrainModel[i].tx, m_terrainModel[i].ty, m_terrainModel[i].tz);
		m_vertices[i].binormal = D3DXVECTOR3(m_terrainModel[i].bx, m_terrainModel[i].by, m_terrainModel[i].bz);
		m_vertices[i].color = D3DXVECTOR3(m_terrainModel[i].r, m_terrainModel[i].g, m_terrainModel[i].b);
	}
